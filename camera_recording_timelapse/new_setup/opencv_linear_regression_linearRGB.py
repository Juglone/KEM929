...
def process_video(video_path):
    ...
    while cap.isOpened():
        ...
        grayscale_values.append(((square_frame.astype("float32").mean() + 0.055) / 1.055)**2.4)
...
def plot_values(video_path, grayscale_values):
    ...
    plt.xlabel('Hours')
    plt.ylabel('Average Grayscale Value in linear sRGB')
    title_text = (
    ...
    # Save plot to folder
    output_folder = "grayscale_graphs_linear_sRGB"
    output_filename = "grayscaleplot_linear_sRGB_" + video_path.split('.')[0] + ".png"
